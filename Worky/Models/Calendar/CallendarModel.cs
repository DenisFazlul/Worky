...
namespace Worky.Models.Calendar
{
    public class CallendarModel
    {
        ...
        public void GetDays()
        {
            ...
            {
                Day day = new Day();
                day.Date = new DateTime(this.CurYear, this.CurMonth.Number+1, i + 1);
                day.Number = i + 1;
                day.GetDayEvents();
                this.Days.Add(day);
            }
        ...
        {
            this.CurMonth = this.months.Where(i => i.Number == month).FirstOrDefault();
        }
        ...
        public void GetMon()
        {
            ...
            {
                Month m = new Month();
                m.Name =ToUp(DateTimeFormatInfo.CurrentInfo.MonthNames[i]);

                m.Number = i;
                this.months.Add(m);
            } 
        }
        public string ToUp(string slovo)
        {


            return slovo = char.ToUpper(slovo[0]) + slovo.Substring(1);
        }
